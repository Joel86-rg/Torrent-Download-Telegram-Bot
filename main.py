...
TorrentBot = Client(api_id=Config.API_ID, api_hash=Config.API_HASH, bot_token=Config.BOT_TOKEN)
    ...
    try:
        ...
        await message.reply_text(
            text="🤗Hello, I am simple Torrent Search Bot!\n\n"
                 ...
                 "**💡Pro Tip: Can't understand this bot?? First learn it by [clicking this.](https://t.me/sanilaassistant_bot) **\n"
                 "**[  Start first](https://t.me/sanilaassistant_bot) > Learn Bots > Torrent Downloader**\n\n"
